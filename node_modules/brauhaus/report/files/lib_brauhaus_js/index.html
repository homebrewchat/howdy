...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="span12">// Generated by CoffeeScript 1.6.3
/*
@preserve
  ...
  Brauhaus.Recipe = (function(_super) {
      ...
      for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
        ...
        if (spice.aa && spice.use.toLowerCase() === 'boil') {
          ...
          if (this.ibuMethod === 'tinseth') {
            ...
            throw new Error("Unknown IBU method '" + this.ibuMethod + "'!");
          }
        }
        this.price += spice.price();
        if (spice.dry()) {
          if ((_base = this.timelineMap['drySpice'])[time] == null) {
            _base[time] = [];
          }
          this.timelineMap['drySpice'][time].push([spice, bitterness]);
        } else {
          if ((_base1 = this.timelineMap['times'])[time] == null) {
            _base1[time] = [];
          }
    ...
    Recipe.prototype.timeline = function(siUnits) {
      ...
      if (this.timelineMap.fermentables.mash.length) {
        ...
        steps = ((_ref4 = this.mash) != null ? _ref4.steps : void 0) || [
      ...
      if (this.timelineMap.fermentables.steep.length) {
        ...
        steepWeight = ((function() {
          ...
          _ref5 = this.timelineMap.fermentables.steep;
          _results = [];
          for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
            _ref6 = _ref5[_j], fermentable = _ref6[0], gravity = _ref6[1];
      ...
      if (this.timelineMap.fermentables.boilEnd.length && __indexOf.call(times, 5) < 0) {
        this.timelineMap.times[5] = [];
        times.push(5);
      }
      previousSpiceTime = 0;
      _ref5 = times.sort(function(x, y) {
        return y - x;
      });
