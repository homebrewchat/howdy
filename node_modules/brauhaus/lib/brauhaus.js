  ...
  */
  ...
  Brauhaus.Recipe = (function(_super) {
    ...
    Recipe.prototype.scale = function(batchSize, boilSize) {
      var adjustment, bitterness, earlyOg, efficiency, fermentable, newEarlyOg, spice, utilization, _i, _j, _len, _len1, _ref4, _ref5;
      earlyOg = 1.0;
      newEarlyOg = 1.0;
      _ref4 = this.fermentables;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
    ...
    Recipe.prototype.grade = function() {
      var filterFunc, grade, ingredients, _i, _len, _ref4, _ref5, _ref6, _ref7;
      grade = 0.0;
      if ((_ref4 = this.name.toLowerCase()) !== '' && _ref4 !== 'new recipe' && _ref4 !== 'untitled') {
        grade += 1.0;
      }
      if ((_ref5 = this.description.toLowerCase()) !== '' && _ref5 !== 'recipe description') {
        grade += 1.0;
      }
      if ((_ref6 = this.author.toLowerCase()) !== '' && _ref6 !== 'anonymous brewer') {
        grade += 1.0;
      }
      if (this.style) {
        grade += 0.5;
      }
      _ref7 = [this.fermentables, this.spices, this.yeast];
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        ingredients = _ref7[_i];
        if (ingredients.length) {
          grade += 1.0;
          filterFunc = function(x) {
            var _ref8;
            return (_ref8 = x.name.toLowerCase()) === '' || _ref8 === 'new fermentable' || _ref8 === 'new spice' || _ref8 === 'new yeast';
          };
    ...
    Recipe.prototype.calculate = function() {
      var attenuation, bitterness, earlyOg, efficiency, fermentable, gravity, gu, mcu, rte, spice, t, time, v, yeast, _base, _base1, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5, _ref6;
      this.og = 1.0;
      this.fg = 0.0;
      this.ibu = 0.0;
      this.price = 0.0;
